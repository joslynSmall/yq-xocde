...
public final class YqBeanUtilsEx extends BeanUtils {

	private static Map cache = new HashMap();
	private static Log logger = LogFactory.getFactory().getInstance(
			YqBeanUtilsEx.class);

	private YqBeanUtilsEx() {
	}
...
//		  
    ...
    private static void setCellValue(HSSFSheet sheet, int row, int col,String value,HSSFCellStyle style) {
